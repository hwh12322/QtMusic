...
void BottomBar::setCoverImage(const QPixmap &image) {
    coverButton->setIcon(image); // 使用新的 setIcon 方法
}

IconButton* BottomBar::getCoverButton() {
    return coverButton;  // 返回 coverButton 的指针
}
